  ...
  const projects = [
    {
      ...
      link: '',
      shortDescription:
        'WIP, production soon up. Mainly 3 people project. A reservation site for the movie theater Kinopoli. Stack included React, Node, Express, SCSS and PostgreSQL.',
      subtitle_1:
